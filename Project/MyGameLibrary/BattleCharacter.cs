...
namespace Fall2020_CSC403_Project.code {
  public class BattleCharacter : Character {
    ...
    public int Heal_cost { get; private set; }
    public int Strength_Up_cost { get; private set; }
    ...
    public BattleCharacter(Vector2 initPos, Collider collider) : base(initPos, collider) {
      ...
      MaxMagic = 20;
      CurrentStrength = 2;
      PlayerStrength = CurrentStrength;
      EnemyStrength = 2;
      Health = MaxHealth;
      Magic = MaxMagic;
      Heal_cost = 5;
    ...
    public void OnAttack(int amount) {
      AttackEvent((int)(amount * PlayerStrength));
    }
    ...
    public void OnHeal(int amount) {
      HealEvent((int)(amount * Heal_cost));
    }
...
/* Maybe make a switch case that change the maxhealth based on difficuly (Do Last)
   Give the battle character magic stats too 
*/